...
public abstract class BaseControllerTest {
  ...
  protected SignUpDTO normalUser = SignUpDTO.builder().email("normal_user@example.com").username("normal_user").password("password1").role(Role.USER).build();
  protected SignUpDTO adminUser = SignUpDTO.builder().email("admin_user@example.com").username("admin_user").password("password2").role(Role.ADMIN).build();
  protected SignUpDTO masterUser = SignUpDTO.builder().email("master_user@example.com").username("master_user").password("password3").role(Role.MASTER).build();
  @Autowired
